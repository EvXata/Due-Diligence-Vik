...
> Read `.claude/skills/shared/phase1-launch-gate.md` and apply the 5-step
> enumeration-and-launch protocol BEFORE any `bcg-segment-analyst` dispatch.
> The gate prevents the Cursor DD bug pattern (skipped-segment-in-batch =
> ~46 min wall-clock recovery cost). Single source of truth — edit there,
> not inline.
